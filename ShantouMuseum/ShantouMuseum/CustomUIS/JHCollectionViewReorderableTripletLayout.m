//
//  JHCollectionViewReorderableTripletLayout.m
//  SmartLife
//
...
@interface UIImageView (JHCollectionViewReorderableTripletLayout)

- (void)setCellCopiedImage:(UICollectionViewCell *)cell;

@end

@implementation UIImageView (JHCollectionViewReorderableTripletLayout)
...
@interface JHCollectionViewReorderableTripletLayout()
...
@implementation JHCollectionViewReorderableTripletLayout

#pragma mark - Override methods

- (id<JHCollectionViewDelegateReorderableTripletLayout>)delegate
{
    return (id<JHCollectionViewDelegateReorderableTripletLayout>)self.collectionView.delegate;
}

- (id<JHCollectionViewReorderableTripletLayoutDataSource>)datasource
{
    return (id<JHCollectionViewReorderableTripletLayoutDataSource>)self.collectionView.dataSource;
}
...
- (void)handleLongPressGesture:(UILongPressGestureRecognizer *)longPress
{
    switch (longPress.state) {
        case UIGestureRecognizerStateBegan: {
            ...
            //animation
            CGRect fakeViewRect = CGRectMake(cell.center.x - (self.largeCellSize.width / 2.f), cell.center.y - (self.largeCellSize.height / 2.f), self.largeCellSize.width, self.largeCellSize.height);
